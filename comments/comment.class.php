...
class Comment
{
	...
	public function markup()
	{
		...
		*/
		...
		$url = 'http://'.dirname($_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"]).'/comments/images/avatar.png';
		...
		return '
			...
			<div class="comment">
				...
				<div class="name">'.$link_open.$d['user_name'].$link_close.'</div>
	...
	public static function validate(&$arr)
	{
		...
		*/
		...
		/*if(!($data['user_name'] = filter_input(INPUT_POST,'name',FILTER_CALLBACK,array('options'=>'Comment::validate_text'))))
		{
			$errors['user_name'] = 'Пожалуйста, введите имя.';
		}*/
